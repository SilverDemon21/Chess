namespace ChessLogic
{
    public class Castle: Move
    {
        ...
        private readonly Direction kingMove;
        ...
        public override bool IsLegal(Board board)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                new NormalMove(kingPosInCopy, kingPosInCopy + kingMove).Execute(copy);
                kingPosInCopy += kingMove;
